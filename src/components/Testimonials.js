...
const Testimonials = (props) => {
  ...
  return (
    ...
    mt-10 p-10 transition-all duration-700 hover:shadow-xl rounded-md sm:mx-auto " >
        ...
        <div className='mt-6' >
            <button onClick={surpriseHandler}
              className="bg-violet-400 hover:bg-violet-500  shadow-md hover:shadow transition-all duration-200 cursor-pointer
